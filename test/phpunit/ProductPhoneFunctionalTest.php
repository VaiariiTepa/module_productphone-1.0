...
/**
 * \file    test/functional/ProductPhoneFunctionalTest.php
...
/**
 * Class ProductPhoneFunctionalTest
 *
 ...
 *
 * @package Testproductphone
 */
class ProductPhoneFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modProductPhone')->click();
		} else {
			// Disable the module
			$this->byHref('modProductPhone')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/productphone/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('productphone/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/productphone/admin/about.php');
		$this->authenticate();
		return $this->assertContains('productphone/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('productphonewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modProductPhone_ProductPhoneTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProductPhone_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
