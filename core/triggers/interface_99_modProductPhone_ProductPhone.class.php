...
require_once DOL_DOCUMENT_ROOT .  '/custom/productphone/class/MyTrigger.php';

/**
 * Class InterfaceMytrigger
 */
class InterfaceProductPhone extends MyTrigger
{
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Le fichier Triggers est prêt a être utilisé ."
			. "Il ne reste plus qu'a adapté le fichier a votre convenance .";
